...
'''Description: This program helps users organize their favorite recipes. 
Users can add recipes with ingredients and instructions, view recipes, and 
search for specific recipes. The program stores recipe data in a JSON file.'''
